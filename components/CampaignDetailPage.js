...
const CampaignDetailPage = ({ campaignId, onBack }) => {
  ...
  const campaignData = {
    1: {
      ...
      shortDescription:
        "Urgent relief for families affected by severe monsoon flooding in Surat city.",
    ...
    Your contribution will help provide life-saving emergency aid, temporary accommodation, medical care, clean water, food supplies, and support for businesses and families to rebuild their lives after the waters recede.`,
      ...
      updates: [
        {
          ...
          content:
            "Water levels are slowly receding in central Surat areas. However, Dabholi and Varachha remain severely flooded. 850 rescue boats are actively evacuating stranded residents from these areas.",
        },
        {
          date: "June 25, 2025",
          time: "11:30 AM",
          ...
          content:
            "15 mobile medical units and 8 emergency medical centers have been established in relief camps. Priority focus on preventing waterborne diseases with over 1,200 medical consultations provided so far.",
        },
        {
          date: "June 24, 2025",
          time: "8:15 PM",
          ...
          content:
            "Large-scale evacuation operations continue with NDRF, SDRF, and local rescue teams. Over 25,000 people have been moved to 45 relief camps across the city. Food distribution reaching 15,000 families daily.",
        },
        {
          date: "June 24, 2025",
          time: "2:30 PM",
          ...
          content:
            "Assessment teams are surveying flooded industrial areas in Pandesara and Sachin. Over 400 diamond and textile units are submerged, affecting thousands of workers. Emergency livelihood support being planned.",
        },
        {
          date: "June 24, 2025",
          time: "6:00 AM",
          ...
          content:
            "Declared municipal emergency as floodwaters entered residential areas. Mayor Dakshesh Mavani coordinating rescue operations. All schools and colleges converted to relief centers.",
        },
      ],
      impactStats: [
        {
      ...
      organizer: {
        ...
        verified: true,
        description:
          "A joint initiative of Surat Municipal Corporation, local NGOs, and business associations with extensive experience in urban flood management. Officially recognized by Gujarat State Disaster Management Authority and supported by diamond and textile industry associations.",
    ...
    2: {
      ...
      shortDescription:
        "Emergency support for families affected by the catastrophic Air India Flight 171 crash.",
    ...
    Your donation will help provide emergency financial assistance to bereaved families, medical treatment for injured survivors, funeral arrangements, legal support for compensation claims, and long-term psychological rehabilitation for the affected community.`,
      ...
      gallery: [
        ...
        "/AhmedabadCrash3.webp",
        "/AhmedabadCrash4.webp",
      ],
      updates: [
        {
          date: "June 25, 2025",
          ...
          content:
            "A dedicated support center for international families has been established at Ahmedabad airport. Consular officials from UK, Portugal, and Canada are providing visa assistance and repatriation support for 61 international families.",
        },
        {
          date: "June 24, 2025",
          time: "6:30 PM",
          ...
          content:
            "Started distributing immediate relief compensation of ₹5 lakhs to each affected family. Special assistance teams are helping families navigate insurance claims and legal procedures for additional compensation.",
        },
        {
          date: "June 23, 2025",
          time: "11:45 AM",
          ...
          content:
            "A memorial service was held for all 280 victims at the crash site. The service was attended by family members, government officials, and airline representatives. A permanent memorial is being planned.",
        },
        {
          date: "June 22, 2025",
          time: "4:20 PM",
          ...
          content:
            "Expanded psychological support services to include 24/7 counseling hotline and mobile crisis intervention teams. Over 150 family members and survivors are receiving specialized trauma therapy.",
        },
        {
          date: "June 20, 2025",
          time: "7:00 AM",
          ...
          content:
            "Recovery operations have identified 270 bodies so far. Forensic teams are working with international experts to ensure proper identification. DNA analysis is being conducted for severely damaged remains.",
        },
        {
          date: "June 15, 2025",
          time: "3:30 PM",
          title: "Emergency Response Activated",
          content:
            "Immediate emergency response teams deployed to crash site. Survivor Vishwash Kumar hospitalized with minor injuries. Emergency helpline established for families seeking information about passengers.",
        },
      ],
      impactStats: [
        {
      ...
      reliefEfforts: [
        {
          item: "Immediate Relief Compensation",
          distributed: "150",
          target: "280",
        },
        {
          item: "International Repatriation Cases",
          distributed: "25",
          target: "61",
        },
        {
          item: "Psychological Counseling Sessions",
          distributed: "450",
          target: "1000",
        },
      ...
      organizer: {
        ...
        verified: true,
        description:
          "A specialized emergency response organization established in collaboration with the Gujarat State Government, Airport Authority of India, and international aviation safety organizations. Experienced in aviation disaster management and victim assistance.",
    ...
    3: {
      ...
      shortDescription:
        "Emergency aid for families affected by the devastating 7.2 magnitude earthquake.",
      ...
      updates: [
        {
          ...
          content:
            "We've successfully deployed 12 mobile medical units across the most affected areas. These units have already treated over 800 patients and continue to provide critical healthcare services.",
        },
        {
          date: "June 23, 2025",
          time: "6:45 PM",
          ...
          content:
            "Thanks to your generous donations, we've established 25 temporary shelter camps housing over 3,000 displaced families. Each shelter is equipped with basic amenities and security.",
        },
        {
          date: "June 22, 2025",
          time: "2:15 PM",
          ...
          content:
            "Our food distribution network has successfully reached 10,000 affected families. We're providing 3 meals per day along with clean drinking water and essential supplies.",
        },
        {
          date: "June 20, 2025",
          time: "8:00 AM",
          title: "Emergency Response Activated",
          content:
            "Immediate emergency response teams have been deployed. Search and rescue operations are ongoing, with priority given to locating survivors and providing medical aid.",
        },
      ],
      impactStats: [
      ...
      reliefEfforts: [
        {
          item: "Emergency Shelter Kits",
          distributed: "2,500",
          target: "5,000",
        },
        {
          item: "Food Packages (7-day)",
          distributed: "8,200",
          target: "15,000",
        },
      ...
      organizer: {
        ...
        verified: true,
        description:
          "A registered NGO with 15+ years of experience in disaster relief operations across India. Certified by the Government of India and partnered with international humanitarian organizations.",
    ...
    4: {
      ...
      shortDescription:
        "Rebuilding homes and lives after catastrophic floods submerged vast areas of Assam.",
      ...
      updates: [
        {
          ...
          content:
            "Our helicopter rescue teams have evacuated 1,200 people from marooned villages today. Priority is being given to pregnant women, children, elderly, and those requiring immediate medical attention.",
        },
        {
          date: "June 23, 2025",
          time: "9:30 AM",
          ...
          content:
            "We've expanded our relief camps to accommodate 15,000 displaced families. Each camp now has improved sanitation facilities, separate spaces for women and children, and 24/7 medical support.",
        },
        {
          date: "June 21, 2025",
          time: "5:45 PM",
          ...
          content:
            "100 motorboats have been distributed to local rescue teams for evacuation and relief distribution in flood-affected areas. These boats are helping reach remote villages cut off by floodwaters.",
        },
      ],
      impactStats: [
        {
      ...
      organizer: {
        ...
        verified: true,
        description:
          "A coalition of 15 NGOs and community organizations with extensive experience in flood relief operations in Northeast India. Recognized by the Assam State Government and UNICEF India.",
    ...
    Your donation will provide emergency shelter, medical care, food security, clean water, and support for rebuilding fire-resistant homes and restoring forest cover for future generations.`,
      ...
      imageUrl: "/UttarakhandWildfire1.webp",
      gallery: [
        "/UttarakhandWildfire1.webp",
        "/UttarakhandWildfire2.webp",
        "/UttarakhandWildfire3.webp",
        "/UttarakhandWildfire4.webp",
      ],
      updates: [
        {
          date: "June 22, 2025",
          ...
          content:
            "Construction of 200 fire-resistant homes using eco-friendly materials has begun in the worst-affected villages. Each home incorporates traditional hill architecture with modern fire safety features.",
        },
        {
          date: "June 20, 2025",
          time: "4:30 PM",
          ...
          content:
            "We've launched a massive reforestation drive with local communities. 50,000 native saplings have been planted across 500 hectares of burned forestland, focusing on fire-resistant species.",
        },
        {
          date: "June 19, 2025",
          time: "8:15 AM",
          ...
          content:
            "Relief materials including blankets, cooking utensils, and emergency supplies have been distributed to 1,200 affected families across 8 districts. Priority given to elderly and children.",
        },
        {
          date: "June 17, 2025",
          time: "2:00 PM",
          ...
          content:
            "12 mobile health units are now operational in fire-affected areas, providing medical care for smoke inhalation, burns, and respiratory issues. Over 800 patients treated so far.",
        },
      ],
      impactStats: [
        {
      ...
      reliefEfforts: [
        ...
        {
          item: "Livelihood Support Packages",
          distributed: "600",
          target: "1,500",
        },
      ],
      organizer: {
        ...
        verified: true,
        description:
          "A consortium of environmental NGOs and community organizations with 20+ years of experience in disaster relief and forest conservation in the Himalayan region. Certified by the Forest Department of Uttarakhand and partnered with WWF India.",
    ...
    6: {
      ...
      shortDescription:
        "Providing urgent relief to families affected by severe flooding in Kerala.",
    ...
    Your contribution will help provide life-saving emergency aid, rehabilitation support, and assistance for rebuilding homes and restoring livelihoods in flood-affected communities across Kerala.`,
      ...
      updates: [
        {
          ...
          content:
            "Launched a fishing boat restoration program for coastal communities. 150 damaged boats are being repaired and 50 new boats distributed to fishermen who lost their primary source of livelihood.",
        },
        {
          date: "June 19, 2025",
          time: "7:20 AM",
          ...
          content:
            "Rehabilitation work has started in 45 flood-damaged schools. Temporary classrooms set up to ensure children can continue their education while permanent structures are being repaired.",
        },
        {
          date: "June 17, 2025",
          time: "3:15 PM",
          ...
          content:
            "Essential supplies and food packets have been distributed to over 2,000 families in the most affected areas. Special focus on pregnant women, elderly, and children with specific nutritional needs.",
        },
        {
          date: "June 16, 2025",
          time: "9:30 AM",
          ...
          content:
            "Coordinated rescue operations using Navy helicopters and local fishing boats have evacuated 3,500 people from marooned areas. Medical teams providing immediate care to rescued individuals.",
        },
      ],
      impactStats: [
        {
      ...
      reliefEfforts: [
        ...
        {
          item: "Fishing Boats (repaired/new)",
          distributed: "200",
          target: "400",
        },
        { item: "School Repair Kits", distributed: "45", target: "120" },
        {
          item: "Household Essential Kits",
          distributed: "8,500",
          target: "20,000",
        },
      ],
      organizer: {
        ...
        verified: true,
        description:
          "A unified coalition of 25+ NGOs, community organizations, and volunteer groups with extensive experience in Kerala's flood relief operations. Officially recognized by Kerala State Disaster Management Authority and partnered with Caritas India.",
    ...
    7: {
      ...
      shortDescription:
        "Emergency relief for families affected by the devastating landslide in Sirmaur district.",
    ...
    Your support will provide life-saving emergency aid, temporary accommodation, medical care, and long-term rehabilitation assistance to help these mountain communities rebuild their lives and restore connectivity to the outside world.`,
      ...
      updates: [
        {
          ...
          content:
            "Construction of an alternative mountain road has begun to reconnect isolated villages. Engineering teams are working on a 15km bypass route expected to be completed within 3 weeks.",
        },
        {
          date: "June 19, 2025",
          time: "3:45 PM",
          ...
          content:
            "Satellite communication systems have been installed in all 8 cut-off villages, enabling families to contact relatives and coordinate rescue efforts. Emergency communication center operational 24/7.",
        },
        {
          date: "June 18, 2025",
          time: "9:00 AM",
          ...
          content:
            "Rescue teams have reached all affected areas using helicopters and mountain paths. Distributed essential supplies to 1,200 families and established 6 relief camps with medical facilities.",
        },
        {
          date: "June 17, 2025",
          time: "6:15 PM",
          ...
          content:
            "Army helicopters have evacuated 45 critically injured individuals and 120 elderly residents to safer locations. Medical airlift operations continue for those requiring specialized treatment.",
        },
        {
          date: "June 16, 2025",
          time: "7:30 AM",
          ...
          content:
            "Specialized search and rescue teams with trained dogs have been deployed to locate missing persons. Rescue operations are being conducted despite challenging terrain and weather conditions.",
        },
      ],
      impactStats: [
      ...
      organizer: {
        ...
        verified: true,
        description:
          "A specialized organization with 18+ years of experience in mountain rescue and disaster relief operations in the Himalayan states. Certified by the National Disaster Management Authority and partnered with the Indian Mountaineering Foundation.",
              ...
              <div className="p-4 sm:p-6">
                ...
                <div className="lg:hidden bg-red-50 border border-red-200 rounded-xl p-4 mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    {Object.entries(campaign.emergencyDetails)
                      .slice(0, 4)
                      .map(([key, value]) => (
                        <div key={key}>
                    ...
                    >
                      ...
                      <div className="hidden lg:block bg-red-50 border border-red-200 rounded-xl p-6">
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-3 gap-6">
                          {Object.entries(campaign.emergencyDetails).map(
                            ([key, value]) => (
                              <div
                                key={key}
                              ...
                              >
                                ...
                                <div className="text-red-800 font-bold text-lg mt-1">
                                  {value}
                                </div>
                              </div>
                            )
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          {campaign.reliefEfforts.map((effort, index) => {
                            const progress =
                              (parseInt(effort.distributed.replace(/,/g, "")) /
                                parseInt(effort.target.replace(/,/g, ""))) *
                              100;
                            return (
                              <motion.div
                                key={index}
                              ...
                              >
                                <div className="flex justify-between items-center mb-2">
                                  ...
                                  <span className="text-sm text-gray-600">
                                    {effort.distributed} / {effort.target}
                                  </span>
                                </div>
